...
$a->strings['Tags:'] = 'Tags:';
$a->strings['%s knows you'] = '%s knows you';
...
$a->strings['Post updated.'] = 'Post updated.';
$a->strings['Item wasn\'t stored.'] = 'Item wasn\'t stored.';
$a->strings['Item couldn\'t be fetched.'] = 'Item couldn\'t be fetched.';
$a->strings['Item not found.'] = 'Item not found.';
...
$a->strings['Your password has been reset.'] = 'Your password has been reset.';
$a->strings['
			Dear %1$s,
...
$a->strings['No keywords to match. Please add keywords to your profile.'] = 'No keywords to match. Please add keywords to your profile.';
...
$a->strings['Message was not deleted.'] = 'Message was not deleted.';
$a->strings['Conversation was not removed.'] = 'Conversation was not removed.';
...
$a->strings['Personal notes are visible only by yourself.'] = 'Personal notes are visible only to you.';
$a->strings['Subscribing to contacts'] = 'Subscribing to contacts';
...
$a->strings['Couldn\'t fetch following contacts.'] = 'Couldn\'t fetch following contacts.';
$a->strings['Couldn\'t fetch remote profile.'] = 'Couldn\'t fetch remote profile.';
$a->strings['Unsupported network'] = 'Unsupported network';
$a->strings['Done'] = 'Done';
...
$a->strings['Failed to delete the photo.'] = 'Failed to delete the photo.';
...
$a->strings['{0} and %d others requested registration'] = '{0} and %d others requested registration';
...
$a->strings['Settings were not updated.'] = 'Settings were not updated.';
...
$a->strings['Enable Content Warning'] = 'Enable Content Warning';
...
$a->strings['Enable intelligent shortening'] = 'Enable intelligent shortening';
$a->strings['Normally the system tries to find the best link to add to shortened posts. If disabled, every shortened post will always point to the original friendica post.'] = 'Normally the system tries to find the best link to add to shortened posts. If disabled, every shortened post will always point to the original Friendica post.';
$a->strings['Enable simple text shortening'] = 'Enable simple text shortening';
...
$a->strings['Your legacy ActivityPub/GNU Social account'] = 'Your legacy ActivityPub/GNU Social account';
...
$a->strings['Publish your profile in your local site directory?'] = 'Publish your profile in your local site directory?';
...
$a->strings['Your profile will also be published in the global friendica directories (e.g. <a href="%s">%s</a>).'] = 'Your profile will also be published in the global Friendica directories (e.g. <a href="%s">%s</a>).';
...
$a->strings['Your current password to confirm the changes of the email address'] = 'Your current password to confirm the changes of the email address';
...
$a->strings['Allow your profile to be searchable globally?'] = 'Allow your profile to be searchable globally?';
...
$a->strings['Hide your contact/friend list from viewers of your profile?'] = 'Hide your contact/friend list from viewers of your profile?';
$a->strings['A list of your contacts is displayed on your profile page. Activate this option to disable the display of your contact list.'] = 'A list of your contacts is displayed on your profile page. Activate this option to disable the display of your contact list.';
...
$a->strings['Make public posts unlisted'] = 'Make public posts unlisted';
...
$a->strings['Make all posted pictures accessible'] = 'Make all posted pictures accessible';
...
$a->strings['Expiration settings'] = 'Expiration settings';
...
$a->strings['When activated, the personal notes on your profile page will be expired.'] = 'If activated, personal notes on your profile page will expire.';
$a->strings['Expire starred posts'] = 'Expire starred posts';
$a->strings['Starring posts keeps them from being expired. That behaviour is overwritten by this setting.'] = 'Starring posts keeps them from being expired. That behaviour is overwritten by this setting.';
$a->strings['Expire photos'] = 'Expire photos';
$a->strings['When activated, photos will be expired.'] = 'If activated, photos will expire.';
$a->strings['Only expire posts by others'] = 'Only expire posts by others';
$a->strings['When activated, your own posts never expire. Then the settings above are only valid for posts you received.'] = 'If activated, your own posts never expire. Than the settings above are only valid for posts you received.';
...
$a->strings['Create a desktop notification when:'] = 'Create a desktop notification when:';
$a->strings['Someone liked your content'] = 'Someone liked your content';
$a->strings['Someone shared your content'] = 'Someone shared your content';
...
$a->strings['Show detailed notifications'] = 'Show detailed notifications';
...
$a->strings['Show notifications of ignored contacts'] = 'Show notifications of ignored contacts';
...
$a->strings['Unable to unfollow this contact, please retry in a few minutes or contact your administrator.'] = 'Unable to unfollow this contact, please retry in a few minutes or contact your administrator.';
$a->strings['Contact was successfully unfollowed'] = 'Contact was successfully unfollowed';
$a->strings['Unable to unfollow this contact, please contact your administrator'] = 'Unable to unfollow this contact, please contact your administrator';
...
$a->strings['Block this author? They won\'t be able to follow you nor see your public posts, and you won\'t be able to see their posts and their notifications.'] = 'Block this author? They won\'t be able to follow you nor see your public posts, and you won\'t be able to see their posts and their notifications.';
...
$a->strings['Common'] = 'Common';
$a->strings['Addon not found'] = 'Addon not found';
$a->strings['Addon already enabled'] = 'Addon already enabled';
$a->strings['Addon already disabled'] = 'Addon already disabled';
...
$a->strings['Enter user nickname: '] = 'Enter user nickname: ';
$a->strings['Enter new password: '] = 'Enter new password: ';
$a->strings['Enter user name: '] = 'Enter user name: ';
$a->strings['Enter user email address: '] = 'Enter user email address: ';
$a->strings['Enter a language (optional): '] = 'Enter a language (optional): ';
$a->strings['User is not pending.'] = 'User is not pending.';
$a->strings['User has already been marked for deletion.'] = 'User has already been marked for deletion.';
$a->strings['Type "yes" to delete %s'] = 'Type "yes" to delete %s';
$a->strings['Deletion aborted.'] = 'Deletion aborted.';
$a->strings['Enter category: '] = 'Enter category: ';
$a->strings['Enter key: '] = 'Enter key: ';
$a->strings['Enter value: '] = 'Enter value: ';
...
$a->strings['<span  %1$s>%2$d people</span> reshared this'] = '<span  %1$s>%2$d people</span> reshared this';
...
$a->strings['Scheduled at'] = 'Scheduled at';
...
$a->strings['You had been addressed (%s).'] = 'You had been addressed (%s).';
$a->strings['You are following %s.'] = 'You are following %s.';
$a->strings['Tagged'] = 'Tagged';
$a->strings['Reshared'] = 'Reshared';
$a->strings['Reshared by %s <%s>'] = 'Reshared by %s <%s>';
$a->strings['%s is participating in this thread.'] = '%s is participating in this thread.';
$a->strings['Stored'] = 'Stored';
$a->strings['Global'] = 'Global';
$a->strings['Relayed'] = 'Relayed';
$a->strings['Relayed by %s <%s>'] = 'Relayed by %s <%s>';
$a->strings['Fetched'] = 'Fetched';
$a->strings['Fetched because of %s <%s>'] = 'Fetched because of %s <%s>';
...
$a->strings['Your postings with media'] = 'Your postings with media';
...
$a->strings['Please see the file "doc/INSTALL.md".'] = 'Please see the file "doc/INSTALL.md".';
...
$a->strings['If you don\'t have a command line version of PHP installed on your server, you will not be able to run the background processing. See <a href=\'https://github.com/friendica/friendica/blob/stable/doc/Install.md#set-up-the-worker\'>\'Setup the worker\'</a>'] = 'If you don\'t have a command line version of PHP installed on your server, you will not be able to run the background processing. See <a href=\'https://github.com/friendica/friendica/blob/stable/doc/Install.md#set-up-the-worker\'>\'Setup the worker\'</a>';
...
$a->strings['Program execution functions'] = 'Program execution functions';
$a->strings['Error: Program execution functions (proc_open) required but not enabled.'] = 'Error: Program execution functions (proc_open) required but not enabled.';
...
$a->strings['You can alternatively skip this procedure and perform a manual installation. Please see the file "doc/INSTALL.md" for instructions.'] = 'You can alternatively skip this procedure and perform a manual installation. Please see the file "doc/INSTALL.md" for instructions.';
...
$a->strings['Url rewrite in .htaccess seems not working. Make sure you copied .htaccess-dist to .htaccess.'] = 'Url rewrite in .htaccess seems not working. Make sure you copied .htaccess-dist to .htaccess.';
$a->strings['In some circumstances (like running inside containers), you can skip this error.'] = 'In some situations like running inside a container, you can skip this error.';
...
$a->strings['It is highly encouraged to use Friendica only over a secure connection as sensitive information like passwords will be transmitted.'] = 'It\'s highly encouraged using Friendica only over a secure connection as sensitive information like passwords will be transmitted.';
$a->strings['Please ensure that the connection to the server is secure.'] = 'Please ensure that the connection to the server is secure.';
$a->strings['No TLS detected'] = 'No TLS detected';
$a->strings['TLS detected'] = 'TLS detected';
...
$a->strings['Friendica can\'t display this page at the moment, please contact the administrator.'] = 'Friendica can\'t display this page at the moment, please contact the administrator.';
$a->strings['template engine cannot be registered without a name.'] = 'template engine cannot be registered without a name.';
$a->strings['template engine is not registered!'] = 'template engine is not registered!';
$a->strings['Updates from version %s are not supported. Please update at least to version 2021.01 and wait until the postupdate finished version 1383.'] = 'Updates from version %s are not supported. Please update at least to version 2021.01 and wait until the postupdate finished version 1383.';
$a->strings['Updates from postupdate version %s are not supported. Please update at least to version 2021.01 and wait until the postupdate finished version 1383.'] = 'Updates from postupdate version %s are not supported. Please update at least to version 2021.01 and wait until the postupdate finished version 1383.';
$a->strings['%s: executing pre update %d'] = '%s: executing pre update %d';
$a->strings['%s: executing post update %d'] = '%s: executing post update %d';
...
$a->strings['The database version had been set to %s.'] = 'The database version had been set to %s.';
$a->strings['The post update is at version %d, it has to be at %d to safely drop the tables.'] = 'The post update is at version %d, it has to be at %d to safely drop the tables.';
$a->strings['No unused tables found.'] = 'No unused tables found.';
$a->strings['There are no tables on MyISAM or InnoDB with the Antelope file format.'] = 'There are no tables on MyISAM or InnoDB with the Antelope file format.';
$a->strings['
...
$a->strings['<strong>Warning!</strong> Advanced function. Could make this server unreachable.'] = '<strong>Warning!</strong> Advanced function. Could make this server unreachable.';
...
$a->strings['Email Banner/Logo'] = 'Email Banner/Logo';
...
$a->strings['Your DB still runs with InnoDB tables in the Antelope file format. You should change the file format to Barracuda. Friendica is using features that are not provided by the Antelope format. See <a href="%s">here</a> for a guide that may be helpful converting the table engines. You may also use the command <tt>php bin/console.php dbstructure toinnodb</tt> of your Friendica installation for an automatic conversion.<br />'] = 'Your DB still runs with InnoDB tables in the Antelope file format. You should change the file format to Barracuda. Friendica is using features that are not provided by the Antelope format. See <a href="%s">here</a> for a guide that may be helpful converting the table engines. You may also use the command <tt>php bin/console.php dbstructure toinnodb</tt> of your Friendica installation for an automatic conversion.<br />';
...
$a->strings['Show some informations regarding the needed information to operate the node according e.g. to <a href="%s" target="_blank" rel="noopener noreferrer">EU-GDPR</a>.'] = 'Show information needed to operate the node according to <a href="%s" target="_blank" rel="noopener noreferrer">EU-GDPR</a>.';
...
$a->strings['Last public item'] = 'Last public item';
...
$a->strings['%s registration revoked'] = [
	0 => '%s registration revoked',
	1 => '%s registrations revoked',
];
$a->strings['Account approved.'] = 'Account approved.';
$a->strings['Registration revoked'] = 'Registration revoked';
...
$a->strings['Manage Accounts'] = 'Manage Accounts';
$a->strings['Connected apps'] = 'Connected apps';
...
$a->strings['Source input (Markdown)'] = 'Source input (Markdown)';
...
$a->strings['Overwrite this field in case the determinated hostname isn\'t right, otherwise leave it as is.'] = 'Overwrite this field in case the hostname is incorrect, otherwise leave it as is.';
...
$a->strings['A Decentralized Social Network'] = 'A Decentralized Social Network';
...
$a->strings['You must be logged in to show this page.'] = 'You must be logged in to show this page.';
...
$a->strings['The Photo with id %s is not available.'] = 'The Photo with id %s is not available.';
...
$a->strings['Forums:'] = 'Forums:';
$a->strings['View profile as:'] = 'View profile as:';
$a->strings['%s\'s timeline'] = '%s\'s timeline';
$a->strings['%s\'s posts'] = '%s\'s posts';
$a->strings['%s\'s comments'] = '%s\'s comments';
$a->strings['Only parent users can create additional accounts.'] = 'Only parent users can create additional accounts.';
...
$a->strings['Please repeat your e-mail address:'] = 'Please repeat your e-mail address:';
...
$a->strings['Password doesn\'t match.'] = 'Password doesn\'t match.';
$a->strings['Please enter your password.'] = 'Please enter your password.';
$a->strings['You have entered too much information.'] = 'You have entered too much information.';
$a->strings['Please enter the identical mail address in the second field.'] = 'Please enter the identical mail address in the second field.';
$a->strings['The additional account was created.'] = 'The additional account was created.';
...
$a->strings['Failed to send email message. Here your account details:<br> login: %s<br> password: %s<br><br>You can change your password after login.'] = 'Failed to send email message. Here your account details:<br> login: %s<br> password: %s<br><br>You can change your password after login.';
...
$a->strings['The provided profile link doesn\'t seem to be valid'] = 'The provided profile link doesn\'t seem to be valid';
...
$a->strings['If you are not yet a member of the free social web, <a href="%s">follow this link to find a public Friendica node and join us today</a>.'] = 'If you are not yet a member of the free social web, <a href="%s">follow this link to find a public Friendica node and join us today</a>.';
...
$a->strings['Additional Accounts'] = 'Additional Accounts';
$a->strings['Register additional accounts that are automatically connected to your existing account so you can manage them from this account.'] = 'Register additional accounts that are automatically connected to your existing account so you can manage them from this account.';
$a->strings['Register an additional account'] = 'Register an additional account';
...
$a->strings['Automatic updates only at the top of the post stream pages'] = 'Automatic updates only at the top of the post stream pages';
$a->strings['Auto update may add new posts at the top of the post stream pages, which can affect the scroll position and perturb normal reading if it happens anywhere else the top of the page.'] = 'Auto update may add new posts at the top of the post stream pages. This can affect the scroll position and perturb normal reading if something happens anywhere else the top of the page.';
$a->strings['Infinite scroll'] = 'Infinite scroll';
$a->strings['Automatic fetch new items when reaching the page end.'] = 'Automatic fetch new items when reaching the page end.';
$a->strings['Beginning of week:'] = 'Week begins: ';
$a->strings['Profile Name is required.'] = 'Profile name is required.';
$a->strings['Profile couldn\'t be updated.'] = 'Profile couldn\'t be updated.';
$a->strings['Label:'] = 'Label:';
$a->strings['Value:'] = 'Value:';
$a->strings['Field Permissions'] = 'Field Permissions';
$a->strings['(click to open/close)'] = '(reveal/hide)';
$a->strings['Add a new profile field'] = 'Add a new profile field';
...
$a->strings['Custom Profile Fields'] = 'Custom Profile Fields';
$a->strings['Upload Profile Photo'] = 'Upload profile photo';
$a->strings['Display name:'] = 'Display name:';
...
$a->strings['<p>Custom fields appear on <a href="%s">your profile page</a>.</p>
				...
				<p>Non-public fields can only be seen by the selected Friendica contacts or the Friendica contacts in the selected groups.</p>'] = '<p>Custom fields appear on <a href="%s">your profile page</a>.</p>
				<p>You can use BBCodes in the field values.</p>
				<p>Reorder by dragging the field title.</p>
				<p>Empty the label field to remove a custom field.</p>
...
$a->strings['Unable to process image'] = 'Unable to process image';
$a->strings['Photo not found.'] = 'Photo not found.';
$a->strings['Profile picture successfully updated.'] = 'Profile picture successfully updated.';
...
$a->strings['Use Image As Is'] = 'Use image as it is.';
$a->strings['Missing uploaded image.'] = 'Missing uploaded image.';
$a->strings['Profile Picture Settings'] = 'Profile Picture Settings';
$a->strings['Current Profile Picture'] = 'Current Profile Picture';
$a->strings['Upload Profile Picture'] = 'Upload Profile Picture';
$a->strings['Upload Picture:'] = 'Upload Picture:';
$a->strings['or'] = 'or';
...
$a->strings['%s may attending %s\'s event'] = '%s may attending %s\'s event';
...
$a->strings['%s New mail received at %s'] = '%s New mail received at %s';
...
$a->strings['%1$s commented on %2$s\'s %3$s %4$s'] = '%1$s commented on %2$s\'s %3$s %4$s';
$a->strings['%1$s commented on your %2$s %3$s'] = '%1$s commented on your %2$s %3$s';
$a->strings['%1$s commented on their %2$s %3$s'] = '%1$s commented on their %2$s %3$s';
$a->strings['%1$s Comment to conversation #%2$d by %3$s'] = '%1$s Comment to conversation #%2$d by %3$s';
...
$a->strings['%s %s posted to your profile wall'] = '%s %s posted to your profile wall';
...
$a->strings['%s A new person is sharing with you'] = '%s A new person is sharing with you';
$a->strings['%1$s is sharing with you at %2$s'] = '%1$s is sharing with you at %2$s';
$a->strings['%s You have a new follower'] = '%s You have a new follower';
$a->strings['You have a new follower at %2$s : %1$s'] = 'You have a new follower at %2$s : %1$s';
$a->strings['%s Friend suggestion received'] = '%s Friend suggestion received';
...
$a->strings['%s Connection accepted'] = '%s Connection accepted';
...
$a->strings['%s %s tagged you'] = '%s %s tagged you';
$a->strings['%s %s shared a new post'] = '%s %s shared a new post';
...
$a->strings['Comment this item on your system'] = 'Comment this item on your system';
